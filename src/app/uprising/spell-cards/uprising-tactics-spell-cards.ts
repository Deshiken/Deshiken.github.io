...
export const UprisingTacticsSpellCards: Array<SpellCard> = [
  ...
  },
  {
    name: `Magic Missile`,
    spellCost: 2,
    htmlDescription: `<p>Using this spell, you may not attack the same unit or building twice. Attack a unit with 4${IconHtml.Attack}. Attack a unit with 3${IconHtml.Attack}. Attack a unit with 2${IconHtml.Attack}.</p>`,
    effectTokens: null,
    regions: null,
    castType: CastType.Normal,
    destructive: true,
